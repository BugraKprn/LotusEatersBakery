...
try
{
    ...
    builder.Services.AddScoped<IMailListService, MailListManager>();
    ...
    if (!app.Environment.IsDevelopment())
    {
        ...
        // The default HSTS value is 30 days. You may want to change this for producti,on scenarios, see https://aka.ms/aspnetcore-hsts.
        app.UseHsts();
    }
